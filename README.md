...
[![Tests](https://img.shields.io/badge/Tests-162%20Passing-success.svg)](backend/tests/)
...
└── testing-ui/           # Developer Testing Console, Prompt Studio, Memory Studio & Tool Studio
```
...
The backend employs a **Modular Clean Architecture** enforcing clean boundary separation between HTTP Routers, Business Services, Tool Orchestration, Memory Orchestration, Prompt Engineering, LLM Runtime Execution, Repositories, and Persistent Infrastructure.
...
All technical documentation, Architecture Decision Records (ADRs 001–043), database constitutions, and coding standards are maintained under:
...
- [ADR Index (ADRs 001 – 043)](backend/docs/architecture/README.md)
...
- [ADR 042: Enterprise Tool Runtime Architecture](backend/docs/architecture/042-enterprise-tool-runtime.md)
- [ADR 043: Tool Engineering Guidelines](backend/docs/architecture/043-tool-engineering-guidelines.md)
...
- **Testing**: pytest (162 passed in strict asyncio mode), `httpx`
- **Developer UI**: Developer Testing Console, Prompt Studio, Memory Studio & Tool Studio (`testing-ui/index.html`)
...
- 🚀 **Phase 7 — Enterprise Messaging Runtime** *(Active Phase)*
  ...
  - ⏳ `7.4` Graph Runtime Integration *(Next Sub-Phase)*
