...
class AIProviderError(AppError):
    ...
    def __init__(
        self,
        message: str = "AI provider encountered an error",
        status_code: int = 500,
...
class ModelUnavailableError(AIProviderError):
    ...
    def __init__(
        self,
        message: str = "AI model service is currently unavailable",
        details: Optional[Any] = None,
    ) -> None:
...
class PromptTooLargeError(AIProviderError):
    ...
    def __init__(
        self,
        message: str = "Prompt exceeds maximum context token window limit",
        details: Optional[Any] = None,
    ) -> None:
...
class RateLimitError(AIProviderError):
    ...
    def __init__(
        self,
        message: str = "AI provider API rate limit exceeded",
        details: Optional[Any] = None,
    ) -> None:
